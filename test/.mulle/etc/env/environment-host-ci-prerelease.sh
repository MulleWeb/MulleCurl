...
#
# MulleObjCStandardFoundation-startup nodetype: ${MULLE_OBJC_STANDARD_FOUNDATION__STARTUP_NODETYPE:-tar}
#
export MULLE_OBJC_STANDARD_FOUNDATION__STARTUP_NODETYPE="git"


#
# MulleObjCStandardFoundation-startup url: ${MULLE_OBJC_STANDARD_FOUNDATION__STARTUP_URL:-https://github.com/MulleFoundation/MulleObjCStandardFoundation-startup/archive/${MULLE_TAG}.tar.gz}
#
export MULLE_OBJC_STANDARD_FOUNDATION__STARTUP_URL="https://github.com/MulleFoundation/MulleObjCStandardFoundation-startup.git"


#
# MulleObjCStandardFoundation-startup branch: ${MULLE_OBJC_STANDARD_FOUNDATION__STARTUP_BRANCH}
#
export MULLE_OBJC_STANDARD_FOUNDATION__STARTUP_BRANCH="prerelease"
...
#
# mulle-container url: ${MULLE__CONTAINER_URL:-https://github.com/mulle-c/mulle-container/archive/${MULLE_TAG}.tar.gz}
#
export MULLE__CONTAINER_URL="https://github.com/mulle-c/mulle-container.git"


#
# mulle-container branch: ${MULLE__CONTAINER_BRANCH}
#
...
#
# mulle-multififo nodetype: ${MULLE__MULTIFIFO_NODETYPE:-tar}
#
export MULLE__MULTIFIFO_NODETYPE="git"


#
# mulle-multififo url: ${MULLE__MULTIFIFO_URL:-https://github.com/mulle-concurrent/mulle-multififo/archive/${MULLE_TAG}.tar.gz}
#
export MULLE__MULTIFIFO_URL="https://github.com/mulle-concurrent/mulle-multififo.git"


#
# mulle-multififo branch: ${MULLE__MULTIFIFO_BRANCH}
#
...
#
# mulle-objc-list nodetype: ${MULLE__OBJC__LIST_NODETYPE:-tar}
#
export MULLE__OBJC__LIST_NODETYPE="git"


#
# mulle-objc-list url: ${MULLE__OBJC__LIST_URL:-https://github.com/mulle-objc/mulle-objc-list/archive/${MULLE_TAG}.tar.gz}
#
...
#
# mulle-time nodetype: ${MULLE__TIME_NODETYPE:-tar}
#
export MULLE__TIME_NODETYPE="git"


#
# mulle-time url: ${MULLE__TIME_URL:-https://github.com/mulle-core/mulle-time/archive/${MULLE_TAG}.tar.gz}
#
export MULLE__TIME_URL="https://github.com/mulle-core/mulle-time.git"


#
# mulle-time branch: ${MULLE__TIME_BRANCH}
#
...
#
# MulleObjCContainerFoundation url: ${MULLE_OBJC_CONTAINER_FOUNDATION_URL:-https://github.com/MulleFoundation/MulleObjCContainerFoundation/archive/${MULLE_TAG}.tar.gz}
#
export MULLE_OBJC_CONTAINER_FOUNDATION_URL="https://github.com/MulleFoundation/MulleObjCContainerFoundation.git"
...
#
# mulle-unicode nodetype: ${MULLE__UNICODE_NODETYPE:-tar}
#
export MULLE__UNICODE_NODETYPE="git"


#
# mulle-unicode url: ${MULLE__UNICODE_URL:-https://github.com/mulle-c/mulle-unicode/archive/${MULLE_TAG}.tar.gz}
#
export MULLE__UNICODE_URL="https://github.com/mulle-c/mulle-unicode.git"


#
# mulle-unicode branch: ${MULLE__UNICODE_BRANCH}
#
export MULLE__UNICODE_BRANCH="prerelease"


#
# MulleObjCJSMNFoundation nodetype: ${MULLE_OBJC_JSMN_FOUNDATION_NODETYPE:-tar}
#
export MULLE_OBJC_JSMN_FOUNDATION_NODETYPE="git"
...
#
# MulleCurl url: ${MULLE_CURL_URL:-https://github.com/MulleWeb/MulleCurl/archive/${MULLE_TAG}.tar.gz}
#
export MULLE_CURL_URL="https://github.com/MulleWeb/MulleCurl.git"


#
# MulleCurl branch: ${MULLE_CURL_BRANCH}
#
export MULLE_CURL_BRANCH="prerelease"


#
# MulleZlib nodetype: ${MULLE_ZLIB_NODETYPE:-tar}
#
export MULLE_ZLIB_NODETYPE="git"
...
#
# MulleZlib branch: ${MULLE_ZLIB_BRANCH}
#
export MULLE_ZLIB_BRANCH="prerelease"
...
#
# mulle-http nodetype: ${MULLE__HTTP_NODETYPE:-tar}
#
export MULLE__HTTP_NODETYPE="git"


#
# mulle-http url: ${MULLE__HTTP_URL:-https://github.com/mulle-c/mulle-http/archive/${MULLE_TAG}.tar.gz}
#
export MULLE__HTTP_URL="https://github.com/mulle-c/mulle-http.git"


#
# mulle-http branch: ${MULLE__HTTP_BRANCH}
#
export MULLE__HTTP_BRANCH="prerelease"


#
# MulleObjCInetFoundation nodetype: ${MULLE_OBJC_INET_FOUNDATION_NODETYPE:-tar}
#
export MULLE_OBJC_INET_FOUNDATION_NODETYPE="git"
...
#
# MulleObjCInetFoundation branch: ${MULLE_OBJC_INET_FOUNDATION_BRANCH}
#
export MULLE_OBJC_INET_FOUNDATION_BRANCH="prerelease"


#
# mulle-url nodetype: ${MULLE__URL_NODETYPE:-tar}
#
export MULLE__URL_NODETYPE="git"


#
# mulle-url url: ${MULLE__URL_URL:-https://github.com/mulle-c/mulle-url/archive/${MULLE_TAG}.tar.gz}
#
export MULLE__URL_URL="https://github.com/mulle-c/mulle-url.git"


#
# mulle-url branch: ${MULLE__URL_BRANCH}
#
