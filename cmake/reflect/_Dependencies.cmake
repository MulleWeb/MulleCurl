...
# Disable for this platform: `mulle-sourcetree mark curl no-cmake-platform-darwin`
#
if( NOT CURL_LIBRARY)
   ...
   if( CURL_LIBRARY)
      ...
      # Disable with: `mulle-sourcetree mark curl no-cmake-searchpath`
      #
      foreach( _TMP_CURL_NAME "curl" "curl-d")
         set( _TMP_CURL_DIR "${_TMP_CURL_ROOT}/include/${_TMP_CURL_NAME}")
...
# Disable for this platform: `mulle-sourcetree mark MulleZlib no-cmake-platform-darwin`
#
if( NOT MULLE_ZLIB_LIBRARY)
   ...
   if( MULLE_ZLIB_LIBRARY)
      ...
      #
      # Append header directory to user search path.
      # Disable with: `mulle-sourcetree mark MulleZlib no-cmake-searchpath`
      #
      foreach( _TMP_MULLE_ZLIB_NAME "MulleZlib")
         set( _TMP_MULLE_ZLIB_DIR "${_TMP_MULLE_ZLIB_ROOT}/include/${_TMP_MULLE_ZLIB_NAME}")
